...
entity & \hl{Entity} & 0..1 & Immutable & \hl{Entity} type uniquely identified by the \hl{Kind} instance. \\
\botrule
\end{tabular}
}
...
\begin{itemize}
\item A structural \hl{Kind} define the capabilities of a \hl{Entity} sub-type in terms of attributes and \hl{Action}s.
...
A non-structural \hl{Kind}, also known as a mix-in, MAY be associated with a
...
\hl{Kind} collection since a \hl{Entity} sub-type instance MUST be associated
with the structural \hl{Kind} of the \hl{Entity} sub-type.
...
\hl{Resource} \hl{Kind} collection.
\begin{description}
...
structural type & \hl{Kind} & 1 & Immutable & The structural \hl{Kind} of the instance. \\
non-structural types & \hl{Kind} & 0..* & Mutable & The non-structural \hl{Kind}s associated to this instance. Consumers can expect the attributes and \hl{Action}s of the associated non-structural \hl{Kind}s to be exposed by the instance. \\ 
\botrule
\end{tabular}
}
...
A \hl{Entity} sub-type instance MUST expose its structural \hl{Kind} and any
