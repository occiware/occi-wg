...
%
In the initial instantiation of the OCCI Core Model, with no core model extensions, three instances
...
inheritance structure of the OCCI Core Model and any extension thereof.
...
{\centering \resizebox*{0.9\columnwidth}{!}{\rotatebox{0}
  ...
  type is an example of an extension of the OCCI Core Model and extends the
  \hl{Resource} type.}
...
define the rules for extensions of the OCCI Core Model.
%
...
The OCCI Core Model MAY be extended through sub-typing for domain-specific purposes.
...
The OCCI Core Model MAY be extended using the mix-in concept \textbf{(Andy: See previous comment (section 4))} by defining
