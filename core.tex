...
Draft \hfill  {Ralf Nyrén, Aurenav}\\
...
\mytablefloat{
  ...
  \begin{tabular}{lp{23mm}llp{60mm}}
    ...
    pattern   &   String    &   0..1    &   Immutable   &   OCCI Attribute pattern, when applicable specified as PCRE, restricts value given to the attribute in instances.\todo{Keeping this?} \\
...
\begin{description}
\item[type] The type of the OCCI Attribute. The types supported are ``Object'',
  ``List'' and ``Hash''.
...
\item[pattern] When specified, places additional restrictions on value given to
  the attribute in instances. Instance attribute value MUST conform to this
  restriction. \todo{Keeping this?}
