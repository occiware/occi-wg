...
Then whenever you make changes simply run "make" to generate new HTML and PDF
versions.

Resources
=========
 * DocBook Official Site: http://www.docbook.org/
 * Wikipedia - DocBook: http://en.wikipedia.org/wiki/DocBook
 * DocBook 5.0: http://www.docbook.org/tdg5/en/html/docbook.html
