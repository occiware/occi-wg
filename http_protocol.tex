...
\section{Filtering}
\todo{Add something about filtering on QI}

\section{HTTP Methods Overview}
\todo{Add text here}, Table~\ref{tbl:http_verbs}.
...
\mytablefloat{
  ...
  \colrule
  \hl{Entity} sub-type instance ({\tt /vms/foo/vm1}).
  & Retrieve the instance representation.
  & Partial update of the instance.
  & Perform an action.
  & Create/Update the instance, supplying the full
    representation of the instance.
  & Delete the instance. \\

  \colrule
  \hl{Entity} sub-type instance collection ({\tt /compute/}).
  & Retrieve a collection of instances*.
  & Create a new instance in this collection.
  & Perform actions on a collection of instances.
  & Not Defined.
  & Remove instances (one, sub-set, all) from the collection. \\

  \colrule
  \hl{Mixin}-defined \hl{Entity} sub-type instance
    collection ({\tt /my\_stuff/}).
  & Retrieve a collection of instances*.
  & Add an instance to this collection.
  & Perform actions on a collection of instances.
  & Update of the collection supplying the full representation
    of the new collection. Including removal and addition of instances.
  & Remove instances (one, sub-set, all) from the collection. \\
  ...
  & Not Defined.
  & Not Defined.
  & Remove a user-defined \hl{Mixin}. \\
  \botrule
  \end{tabularx}
}
