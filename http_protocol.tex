...
\paragraph{Server GET response}
The reponse MUST include a rendering of a collection.
...
\paragraph{Client PUT request}
The message MUST include a full rendering of the collection.
...
MUST include at least one full entity rendering. It MAY include mutliple full entity renderings.

\paragraph{Server POST response}
In case server replies with \emph{200 OK} HTTP status code it MUST include either a rendering of collection or single entity rendering. In case a \emph{201 CREATED} HTTP status code a URI to a entity instance or a list of entity instance URIs MUST be returned.
...
\paragraph{Server POST response}
On successfull operation the server replies with the \emph{200 OK} HTTP status code it MUST include a rendering of collection.
...
\paragraph{Server POST reponse}
The message of the HTTP GET response MUST contain a full rendering of the collection rendering.
...
\paragraph{Server GET response}
The reponse MUST include a list of all category renderings.
...
\paragraph{Client POST request}
MUST include at least one full category rendering. It MAY include mutliple full category renderings.
...
\paragraph{Client DELETE request}
MUST include at least one full category rendering. It MAY include multiple full category renderings.
