...
\mytablefloat{
	...
	Attributes defined for the Category type}
	{
...
\mytablefloat{	   
    ...
    \toprule
     Attribute & XML type & Description & Required \\
    \colrule
    name & XSD string & OCCI Attribute name & yes\\
    type & XSD base type & OCCI Attribute type & no\\
    title & XSD string & A descriptin of the OCCI Attribute & no \\
    use & optional | required & Whether the OCCI Attribute must be supplied by the client at instance creation time & no\\
    default & XML base type & OCCI Attribute default value & no\\
    immutable & XSD boolean & OCCI Attribute mutability & no \\
    \botrule
    \end{tabularx}
}
\FloatBarrier
