...
In order to render an OCCI representation solely in the header, i.e.~using the
\textit{text/occi} content type, the X-OCCI-Location HTTP header MUST be used
to return a list of \hl{Entity} URIs. Each header field value correspond to a
single URI. Multiple \hl{Entity} URIs are returned using multiple
