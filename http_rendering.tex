...
\colrule
resource instance (/vms/user1/vm1) 	& Retrieval of the resource instance 		& Partial update of the resource instance 			& Perform an action 								& Update (using the full representation) of the resource instance/Creation of a resource instance	& Deletion of the resource instance \\
\colrule
\hl{Kind} collection (/compute/) 	& Retrieve a set of resource instances* 	& Create a new resource instance of this \hl{Kind}	& Performs actions on a set of resource instances 	& Not Defined		& Removal of a (set of) resource instance from collection \\
\colrule
\hl{Mixin} collection (/my\_stuff/) 	& Retrieve a set of resource instances* 	& Adds a resource instance to this collection 		& Performs actions on a set of resource instances 	& Update (using the full representation) of the collection (Includes removal and addition of resources) 		& Removal of a (set of) resource instance from collection \\
\colrule
...
\textbf{Resource instance of the type \hl{Link} and \hl{Resource} MUST
