...
\colrule
\hl{Kind} collection (/compute/) 	& Retrieve a set of resource instances* 	& Create a new resource instance of this \hl{Kind}	& Performs actions on a set of resource instances 	& Update (using the full representation) of the collection 		& Removal of a (set of) resource instance from collection \\
\colrule
