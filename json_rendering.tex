...
For an example of rendered Attributes please refer for instance to the Resource instance rendering example in Appendix~\ref{resouce_instance_rendering_example}.
