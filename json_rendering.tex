...
following example. Appendix~\ref{resouce_instance_rendering_example} contains a detailed
example.
...
following example. Appendix~\ref{action_invocation_rendering_example} contains a detailed example.
...
following example. Appendix~\ref{link_instance_rendering_example} contains a detailed example.
...
following example. Appendix~\ref{kind_instance_rendering_example} contains a detailed example.
...
The OCCI Mixin Instance Rendering consists of a JSON object as shown in the following example. Appendix~\ref{mixin_instance_rendering_example} contains a detailed example.
...
following example. Appendix~\ref{action_instance_rendering_example} contains a detailed example.
