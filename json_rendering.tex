...
\mytablefloat{
    ...
    source        & String            & immutable   & 1             & URI of the source OCCI Resource. If only one OCCI Resource is rendered in the same collection, this OCCI Resource is the source of the OCCI Link if this entry is omitted.\\

    source.kind   & String            & immutable   & 0..1          & Kind identifier of the source Resource. \\

    target        & String            & immutable   & 1             & URI of the target Resource. \\

    target.kind   & String            & immutable   & 0..1          & Kind identifier of the target Resource, to be supplied if the target is an OCCI Resource. \\
...
\begin{lstlisting}
{
    ...
    "target.kind":"http://schemas.ogf.org/occi/infrastructure#compute",
