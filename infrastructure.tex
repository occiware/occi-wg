...
\mytablefloat{
	...
	\botrule
	\end{tabular}
\textbf{Note: http://schemas.ogf.org/occi has been replaces with
  $<$schema$>$ in this table for a better readability experience} }
...
\mytablefloat{
	\label{tbl:networklink}Attributes defined for the \hl{NetworkInterface} type.
}
{
...
\mytablefloat{
	\label{tbl:storagelink}Attributes defined for the \hl{StorageLink} type. 
}
{
