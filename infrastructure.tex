...
Table~\ref{tbl:compute} describes the attributes \footnote{See ’attributes’ in the inherited base type Category  \cite{occi:core}} 
...
by an instance of the Compute type of an OCCI implementation. 
