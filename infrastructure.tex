...
%{\bf Ralf: Need a reference between the above statement and the diagrams in question. 
%One option is to have the Figure captions starts with ``UML activity diagram for ...''.}
