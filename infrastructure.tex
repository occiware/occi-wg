...
Define category
term ipnetwork; scheme=''http://schemas.ogf.org/occi/infrastructure/network\#' title='what ever you want - IP network mixin, L3'
Description
...
The Networkinterface Link type is assigned the http://schemas.ogf.org/occi/infrastructure\#networkinterface Category. A Networkinterface Link instance MUST at least expose this Category.
...
Define category
term ipnetworkinterface; scheme=''http://schemas.ogf.org/occi/infrastructure/networkinterface\#' title='what ever you want - IP network interface mixin, L3'
Description
