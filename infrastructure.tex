...
each of them, including type-specific mixins (\hl{IPNetwork} and
\hl{IPNetworkInterface}) where appropriate. Following those, the
definition of infrastructure-related \hl{Link} sub-types are given and
finally OS and Resource Templates are defined.
Figure~\ref{fig:infra_uml} gives an overview of the various types
involved in this infrastructure specification.
