...
\todo{Need to fix Link (Model Attributes + 'target' arrow) in Figure~\ref{fig:infra_uml}. No idea how to open $\ast$.zuml!}
...
by setting the \textit{depends} attribute to:
...
}
{
	...
	occi.storage.state & Enum \{online, offline, error\} & 1 & Immutable 
...
Attribute&Type&Multi\-plicity&Mutability&Description\\
\colrule
occi.compute.user\_data & String & 1 & Mutable &
