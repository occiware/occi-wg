...
\end{itemize}
%
\todo{replace with 1.2, note backwards compatibility. define new set of docs for 1.2 below...}
\todo{add table showing what should be implemented for what version to be compliant}
...
%The documents of the current OCCI specification suite are:
%
%\begin{description}
...
%extension for the IaaS domain \cite{occi:infrastructure}. The document
%extends the OCCI Core Model with additional Entity sub-types and their associated
